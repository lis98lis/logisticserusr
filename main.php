        ...
        <div class="hero__container">
            <div class="hero__body">
                <div class="hero__content">
                    ...
                    <a href="<?php the_field('main_link'); ?>" class="calc-btn openModalBtn link_about_us" data-modal="modal">
                        <img
                                ...
                                <div class="item-transporation__body">
                                    <div class="item-transporation__header">
                                        <div class="item-transporation__top">
                                            ...
                                            />
                                            <div class="item-transporation__title"><?php the_sub_field('country_title') ?></div>
                                        </div>
                                        <div>
                                            <img
                                    ...
                                    <div class="item-transporation__about">
                                        ...
                                        <p class="item-transporation__description">
                                            <?php the_sub_field('description_transportation') ?>
                                        </p>
                                        <a href="<?php the_sub_field('specify_transportation_link'); ?>" class="calc-btn__small openModalBtn">
                                            <img src="<?php echo get_template_directory_uri(); ?>/img/icons/calculator.svg"
                                                 alt="calc"/>
                                            <?php the_sub_field('transportation_button') ?>
                                        </a>
    ...
    <section class="services">
        <div class="services__container">
                    ...
                    if (have_rows('additional_services')):
                        ...
                        while (have_rows('additional_services')) : the_row(); ?>
                            <li class="additional__item">
                                <a href="<?php the_sub_field('name_additional_link') ?>">
            ...
            <div class="calculation">
                <div class="calculation__author" id="calculation-author"></div>
    ...
    <section class="delivery">
        <div class="delivery__container">
            ...
            <div class="delivery__body">
                ...
                // проверяем есть ли в повторителе данные
                if (have_rows('shipping_methods')):

                    // перебираем данные
                    while (have_rows('shipping_methods')) : the_row(); ?>
                        <div class="item-delivery">
                            <img
                                    src="<?php the_sub_field('delivery_image'); ?>"
                                    class="item-delivery__img"
                                    alt="delivery img"
                            />
                            <div class="item-delivery__body">
                                <div class="item-delivery__title"><?php the_sub_field('delivery_header'); ?></div>
                                ...
                                <p class="item-delivery__description">
                                    <?php the_sub_field('delivery_description'); ?>
                                </p>
                                <a href="<?php the_sub_field('specify_delivery_link'); ?>" class="calc-btn__s"><?php the_sub_field('delivery_button'); ?></a>
                            </div>
                        </div>
    ...
    <section class="info">
        <div class="about">
            ...
            <div class="about__container about__body">
                ...
                <a href="<?php  the_field('Link_about_us'); ?>" class="calc-btn__s link_about_us"><?php  the_field('about-us_button'); ?></a>
            </div>
        </div>
        <div class="steps__container">
            <div class="steps">
                <div class="about__title"><?php the_field('title_stages_work'); ?></div>
                <div class="steps__body">

                    <?php

                    // проверяем есть ли в повторителе данные
                    if (have_rows('stages_work')):

                        // перебираем данные
                        while (have_rows('stages_work')) : the_row(); ?>
                            <div class="steps__item item-steps">
                                <div class="item-steps__top">
                                    <img
                                            src="<?php the_sub_field('stage_Image'); ?>"
                                            class="item-steps__img"
                                            alt="step preview"
                                    />
                                    <span class="item-steps__step"><?php the_sub_field('stage_number'); ?></span>
                                </div>
                                <p class="item-steps__content">
                                    <?php the_sub_field('stage_description'); ?>
                                </p>
                            </div>
        ...
        <div class="consultation">
            <picture>
                <source
                        srcset="<?php the_field('consultant_Image'); ?>"
                        class="consultation__bg"
                        type="image/webp"
                />
                <img
                        src="<?php the_field('consultant_Image'); ?>"
                        class="consultation__bg"
        ...
        <div class="question-block__container">
            ...
            <div class="question-block__inner">
                <div class="question-block__spollers">
                    ...
                    <?php
                    // проверяем есть ли в повторителе данные
                    if (have_rows('answers_questions')):
                        // перебираем данные
                        while (have_rows('answers_questions')) : the_row(); ?>
                            <div class="question-block__item">
                                <div class="question-block__question">
                                    <?php the_sub_field('write_question'); ?>
                                    <img
                                ...
                                <div class="question-block__body">
                                    <?php the_sub_field('write_answer_question'); ?>
                                </div>
                            </div>
                        <?php endwhile;
                    else :
            ...
            <div class="contacts__info">
                ...
                <div class="contacts__info-body">
                    <div class="contacts__info-item contacts-item">
                        ...
                        <a class="contacts-item__link" href="tel:<?php the_field('phone_number_questions_answers'); ?>"><?php the_field('phone_number_contact'); ?></a>
                    </div>
                    <div class="contacts__info-item contacts-item">
                        <span class="contacts-item__label"><?php the_field('email_name'); ?></span>
                        <a class="contacts-item__link" href="<?php the_field('write_email_contact'); ?>"><?php the_field('write_email_contact'); ?></a>
                    </div>
                    <div class="contacts__info-item contacts-item">
                        <span class="contacts-item__label"><?php the_field('Work_schedule'); ?></span>
                        <div class="contacts-item__text"><?php the_field('schedule_time'); ?></div>
                    </div>
                    <p class="contacts__info-text">
                        <?php the_field('additional_information'); ?>
                    </p>
                    <a href="<?php the_field('contact_button_link'); ?>" type="submit" class="calc-btn__small">
